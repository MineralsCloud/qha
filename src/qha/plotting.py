...
class Plotter:
    ...
    def plot_thermal_expansion(self):
        ...
        ax.legend(
            frameon=False, bbox_to_anchor=(1.02, 1), loc="upper left", title="P (GPa)"
        )
    ...
    def fv_pv(self):
        ...
        volume_nonfitted_t = volume_nonfitted_vt.loc[
            :, volume_nonfitted_vt.columns.isin(temperature_sample)
        ]
        ...
        v_f_min = np.asarray(v_f_min, dtype=float)
